...
#INPUT_CSV = "datasets/XSS_fixed_enhanced.csv"
...
joblib.dump(vectorizer, os.path.join(MODEL_DIR, "newvectorizer.joblib"))
joblib.dump(clf, os.path.join(MODEL_DIR, "newmodel.joblib"))
